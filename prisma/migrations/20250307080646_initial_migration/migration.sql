...
*/
-- CreateEnum
CREATE TYPE "ClassifiedStatus" AS ENUM ('LIVE', 'SOLD', 'DRAFT');

-- CreateEnum
CREATE TYPE "CurrencyCode" AS ENUM ('NGN', 'EURO', 'USD');

-- CreateEnum
CREATE TYPE "OdoUnit" AS ENUM ('MILES', 'KILOMETRES');

-- CreateEnum
CREATE TYPE "BodyType" AS ENUM ('SEDAN', 'HATCHBACK', 'SUV', 'COUPE', 'CONVERTIBLE', 'PICKUP', 'WAGON');
...
-- CreateEnum
CREATE TYPE "Colour" AS ENUM ('BLACK', 'WHITE', 'RED', 'BLUE', 'GREEN', 'YELLOW');

-- CreateEnum
CREATE TYPE "ULEZCompliance" AS ENUM ('EXEMPT', 'COMPLIANT', 'NON_COMPLIANT');

-- CreateEnum
CREATE TYPE "CustomerStatus" AS ENUM ('SUBSCRIBER', 'INTERESTED', 'CONTACTED', 'PURCHASED', 'SOLD');
...
CREATE TABLE "classifieds" (
    ...
    "odo_reading" INTEGER NOT NULL DEFAULT 1,
...
-- AddForeignKey
ALTER TABLE "classifieds" ADD CONSTRAINT "classifieds_make_id_fkey" FOREIGN KEY ("make_id") REFERENCES "makes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "classifieds" ADD CONSTRAINT "classifieds_model_id_fkey" FOREIGN KEY ("model_id") REFERENCES "models"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "classifieds" ADD CONSTRAINT "classifieds_model_variant_id_fkey" FOREIGN KEY ("model_variant_id") REFERENCES "model_variants"("id") ON DELETE CASCADE ON UPDATE CASCADE;
